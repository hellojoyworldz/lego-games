...
// Sound
GameManager.prototype.toggleSound = function () {
  ...
  document.getElementById('sound-toggle').classList.toggle('sound-on', soundEnabled);
  document.getElementById('sound-toggle').classList.toggle('sound-off', !soundEnabled);
};
